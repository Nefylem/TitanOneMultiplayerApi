...
namespace TitanOneMultiplayerApi.Remapping
{
    public static class GamepadMap
    {
        ...
        public static int RightTrigger;          //0 - 100
        [Description("Right Stick")]
        public static int RightStick;
        [Description("Left Shoulder")]
        public static int LeftShoulder;
        [Description("Left Trigger")]
        public static int LeftTrigger;            //0 - 100
        [Description("Left Stick")]
        public static int LeftStick;
        ...
        public static int AccX;                //rotate X. 90 = -25, 180 = 0, 270 = +25, 360 = 0
        [Description("Accelerometer Y")]
        public static int AccY;                //shake vertically. +25 (top) to -25 (bottom)
        [Description("Accelerometer Z")]
        public static int AccZ;                //tilt
        [Description("Gyro X")]
        ...
        [Description("Touchpad X")]
        public static int TouchX;
        [Description("Touchpad Y")]
        public static int TouchY;

        //Change these defintions if you want to remap your controller inputs. 
        static GamepadMap()
        {
            Home = 0;
            Back = 1;
