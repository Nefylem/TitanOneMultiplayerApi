...
namespace TitanOneMultiplayerApi.GamepadInput
{
    ...
    public struct GamePadButtons
    {
        ...
        public bool Start => start == ButtonState.Pressed;

        public bool Back => back == ButtonState.Pressed;

        public bool Guide => guide == ButtonState.Pressed;

        public bool LeftStick => leftStick == ButtonState.Pressed;

        public bool RightStick => rightStick == ButtonState.Pressed;

        public bool LeftShoulder => leftShoulder == ButtonState.Pressed;

        public bool RightShoulder => rightShoulder == ButtonState.Pressed;

        public bool A => a == ButtonState.Pressed;

        public bool B => b == ButtonState.Pressed;

        public bool X => x == ButtonState.Pressed;

        public bool Y => y == ButtonState.Pressed;
    }
    ...
    public struct GamePadDPad
    {
        ...
        public bool Up => up == ButtonState.Pressed;

        public bool Down => down == ButtonState.Pressed;

        public bool Left => left == ButtonState.Pressed;

        public bool Right => right == ButtonState.Pressed;
    }
